...
Please keep in mind the intended scope of this package: to provide file annotations for test errors and other common CI checks from a GitHub Action.
...
If you find a security-related issue with this project, please refrain from opening a public issue and instead [contact the maintainer](https://hachyderm.io/@ajf).
